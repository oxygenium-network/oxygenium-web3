...
- This code imports several functions and types from the "@oxygenium-network/web3" library, as well as a JSON file containing the ABI of the NFTTest contract.
