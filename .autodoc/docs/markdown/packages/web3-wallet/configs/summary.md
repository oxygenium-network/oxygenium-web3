...
For example, a developer might use the `alephium-web3` library to create a new instance of the `web3` object, which can be used to interact with the Oxygenium blockchain:

```javascript
const OxygeniumWeb3 = require('alephium-web3');
