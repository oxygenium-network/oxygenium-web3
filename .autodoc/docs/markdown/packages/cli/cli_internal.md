...
This file contains a set of commands that can be used to manage and interact with a smart contract project built on the Oxygenium blockchain. The file imports several modules from the `@alephium/web3` package, which provides a set of tools for interacting with the Oxygenium blockchain. 
